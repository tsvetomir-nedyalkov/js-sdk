...
// NetworkStore class
export class NetworkStore<T extends Entity = Entity> {
...
// CacheStore class
export class CacheStore<T extends Entity = Entity> extends NetworkStore<T> {
...
// SyncStore class
export class SyncStore<T extends Entity = Entity> extends CacheStore<T> { }
